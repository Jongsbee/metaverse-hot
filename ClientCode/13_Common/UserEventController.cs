...
public class UserEventController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        ResultPopUp = uiManager.transform.Find("MidCenter_PopUps/PopUp_Interaction").gameObject;
        InteractionPopUp = uiManager.transform.Find("MidCenter_PopUps/PopUp_Result").gameObject;
