...
//    void Awake()
//    {
//        myAPIClient = GameObject.Find("FirebaseController").GetComponent<MyAPIClient>();
//    }
...
//    {
//        Debug.Log("OpenProfilePanel() method called");
//        loginPanel.SetActive(false);
//        signupPanel.SetActive(false);
...
//    {
//        Debug.Log("OpenForgetPasswordPanel() method called");
//        loginPanel.SetActive(false);
//        signupPanel.SetActive(false);
//        profilePanel.SetActive(false);
...
//        StartCoroutine(myAPIClient.getRequest(url, dupleSuccess, dupleError)); // geturl 로 전송
...
//            // 서버에 해당 값을 전송
//            StartCoroutine(myAPIClient.PostRequest(url, data, signInSuccess, signInError));
